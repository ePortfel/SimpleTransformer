...
# Parametry modelu
tokens=1800                 # liczba tokenów w słowniku 
rozmiar_bloku=400           # Rozmiar fragmentu tekstu (w tokenach) do analizy kolejnego tokena (GPT-3: 2048)
kanaly_uwagi=9              # Liczba równoległych kanałów aplikacji mechanizmu uwagi (GPT-3: 96) 
...
iteracje=3000               # Liczba iteracji uczenia
