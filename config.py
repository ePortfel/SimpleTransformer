# Parametry modelu o 120mln parametrów  (GPT-3 ma 175mld parametrów)
...
atrybuty= moduly_uwagi*192  # Liczba cech kodujących token tekstu (GPT-3: 12288)
...
iteracje=20                 # Liczba iteracji uczenia
